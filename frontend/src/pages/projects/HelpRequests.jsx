...
import {
  createHelpRequest,
  getHelpRequests,
} from "../../apiRequests/helpRequests"; // Updated path
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch(
        "https://elevatehub-proxy.mijuzz007.workers.dev/api/categories/",
        {
          credentials: "include",
        }
      );
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    <label htmlFor="credit_offer_chat" className="form-label">
                      Chat Credit Offer
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="mb-3">
                    <label htmlFor="credit_offer_video" className="form-label">
                      Video Credit Offer
                    </label>
                    <input
                      type="number"
                ...
                <div className="card h-100 shadow-sm">
                  <div className="card-body d-flex flex-column">
                    ...
                    <div className="mt-2">
                      <span
                        className={`badge ${
                          req.status === "open" ? "bg-success" : "bg-secondary"
                        } me-2`}
                      >
                        {req.status}
                      </span>
                      <span className="badge bg-info">
                        Chat: {req.credit_offer_chat} credits
                      </span>
                      <span className="badge bg-info ms-2">
                        Video: {req.credit_offer_video} credits
                      </span>
                    </div>
                    <a
