...
class HelpCommentSerializer(serializers.ModelSerializer):
    ...
    help_request = serializers.PrimaryKeyRelatedField(read_only=True)  # Make read-only
    class Meta:
        model = HelpComment
...
class HelpRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HelpRequest
        fields = ['id', 'title', 'description', 'category', 'created_by', 'created_at', 'status', 'credit_offer_chat', 'credit_offer_video', 'comments']